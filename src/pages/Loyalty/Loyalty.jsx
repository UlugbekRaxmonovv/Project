        ...
        <div className="py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-700">
                В нашем магазине предусмотрена кешбэк-система. То есть мы
                возвращаем вам часть денег от суммы покупки. Накапливая баллы на
                внутреннем счету, вы можете потратить их на новые покупки.
              </p>
