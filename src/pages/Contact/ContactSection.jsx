          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-2">
                <IoLocationOutline className="w-5 h-5 text-pink-500 mt-1 flex-shrink-0" />

                <div>
                  <div className="text-gray-700">Адрес:</div>
                  <div className="text-gray-600">
                    Ташкент массив Ц-2, следж от главного входа на Алайский
                    рынок
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-2">
                <MdOutlineLocalPhone className="w-5 h-5 text-pink-500 mt-1 flex-shrink-0" />

                <div>
                  <div className="text-gray-700">Контакты:</div>
                  <a
                    href="tel:+998900891484"
